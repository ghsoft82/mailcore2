...
IMAPSearchExpression * IMAPSession::searchExpressionFromSearchKind(IMAPSearchKind kind, String * searchString)
{
...
IndexSet * IMAPSession::search(String * folder, IMAPSearchKind kind, String * searchString, ErrorCode * pError)
{
    ...
    expr = searchExpressionFromSearchKind(kind, searchString);
...
static struct mailimap_sort_key * sortKeyFromKind(IMAPSortKind sortKind, int isReverse)
{
    switch (sortKind)
    {
        case IMAPSortKindByArrival:

        {
            return mailimap_sort_key_new_arrival(isReverse);
        }
        case IMAPSortKindByDate:

        {
            return mailimap_sort_key_new_date(isReverse);
        }
        case IMAPSortKindByFrom:

        {
            return mailimap_sort_key_new_from(isReverse);
        }
        case IMAPSortKindByTo:

        {
            return mailimap_sort_key_new_to(isReverse);
        }
        case IMAPSortKindByCC:

        {
            return mailimap_sort_key_new_cc(isReverse);
        }
        case IMAPSortKindBySubject:

        {
            return mailimap_sort_key_new_subject(isReverse);
        }
        case IMAPSortKindBySize:

        {
            return mailimap_sort_key_new_size(isReverse);
        }
...
Array * IMAPSession::sort(String * folder, IMAPSortKind sortKind, int isReverse, IMAPSearchKind searchKind, String * searchString, ErrorCode * pError)
{
    IMAPSearchExpression * expr;
    expr = searchExpressionFromSearchKind(searchKind, searchString);

    return sort(folder, sortKind, isReverse, expr, pError);
}

Array * IMAPSession::sort(String * folder, IMAPSortKind sortKind, int isReverse, IMAPSearchExpression * searchExpression, ErrorCode * pError)
{
    ...
    int r = mailimap_uid_sort(mImap, charset, sort_key, search_key, &result_list);
