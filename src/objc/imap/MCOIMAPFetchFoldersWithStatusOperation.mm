//
//  MCOIMAPFetchFoldersWithStatusOperation.m
//  mailcore2
//
...
@implementation MCOIMAPFetchFoldersWithStatusOperation {
    CompletionType _completionBlock;
}

#define nativeType mailcore::IMAPFetchFoldersWithStatusOperation
